...
1. Select **New API** and enter `WildRydes-student#` for the **API Name**, where "#" is your student number.
...
1. Enter `WildRydes-student#` for the Authorizer name.
...
1. Enter `WildRydes-student#` (or the name you gave your user pool) in the **Cognito User Pool** input.
...
1. Update the **invokeUrl** setting under the **api** key in the config.js file. Set the value to the **Invoke URL** for the deployment stage your created in the previous section.
    ...
    window._config = {
        ...
        api: {
            invokeUrl: 'https://rc7nyt4tql.execute-api.us-east-2.amazonaws.com/prod' // e.g. https://rc7nyt4tql.execute-api.us-east-2.amazonaws.com/prod,
        }
    };
    ```
